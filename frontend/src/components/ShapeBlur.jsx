// React Bits ShapeBlur. BEBO-aanpassingen (gemarkeerd met BEBO:): render-loop pauzeert
// buiten beeld en de pixelratio is begrensd voor prestaties.
...
const ShapeBlur = ({
  ...
  useEffect(() => {
    ...
    const resize = () => {
      ...
      const dpr = Math.min(window.devicePixelRatio, 1.5); // BEBO: was 2
    ...
    // BEBO: alleen renderen als het canvas in beeld is.
    let visible = true;
    const io = new IntersectionObserver(([entry]) => {
      const was = visible;
      visible = entry.isIntersecting;
      if (visible && !was && active) {
